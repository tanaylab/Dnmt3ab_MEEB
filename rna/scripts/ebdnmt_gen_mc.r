...
generate_mc("eseb_07_wt", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
#			Knn = 100, Knn_core=18,
			min_mc_sz=15,
...
generate_mc("eseb_07_3a", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
...
generate_mc("eseb_07_3b", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
...
generate_mc("eseb_07_3ab", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
...
generate_mc("eseb_07_D1", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
...
generate_mc("eseb_07_TKO", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
...
if(0) {
bad_genes07 = c(as.character(read.table("data/filtered_genes_eseb07_wt.txt",sep="\t")$x))
generate_mc("eseb_sEB8_wt", color_key="config/wt05_mc_colorize.txt",
			recompute=T, 
			Knn = 80, Knn_core=15,
			min_mc_sz=15,
			add_bad_genes = bad_genes07)
