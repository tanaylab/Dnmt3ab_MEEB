...
if (do_3b) {
    ...
    names(md_vals) <- names(mc@mc)
    md_vals <- paste(md[names(mc@mc), "line"], md_vals, sep = "_")
    mcell_mc2d_plot_by_factor("eseb_07_3b_bs500f_got_s2m", "eseb_07_3b",
        meta_field = "rep_and_day",
        meta_data_vals = md_vals, ncols = 8, single_plot = F, neto_points = T
    )
}
...
if (do_3a) {
    ...
    md_vals <- paste(md[names(mc@mc), "line"], md_vals, sep = "_")
    names(md_vals) <- names(mc@mc)
    mcell_mc2d_plot_by_factor("eseb_07_3a_bs500f_got_s2m", "eseb_07_3a",
        meta_field = "rep_and_day",
        meta_data_vals = md_vals, ncols = 8, single_plot = F, neto_points = T
    )
}
...
if (do_3ab) {
    ...
    md_vals <- paste(md[names(mc@mc), "line"], md_vals, sep = "_")
    names(md_vals) <- names(mc@mc)
    mcell_mc2d_plot_by_factor("eseb_07_3ab_bs500f_got_s2m", "eseb_07_3ab",
        meta_field = "rep_and_day",
        meta_data_vals = md_vals, ncols = 8, single_plot = F, neto_points = T
    )
}
...
if (do_D1) {
    ...
    md_vals <- paste(md[names(mc@mc), "line"], md_vals, sep = "_")
    names(md_vals) <- names(mc@mc)
    mcell_mc2d_plot_by_factor("eseb_07_D1_bs500f_got_s2m", "eseb_07_D1",
        meta_field = "rep_and_day",
        meta_data_vals = md_vals, ncols = 8, single_plot = F, neto_points = T
    )
}
...
if (do_TKO) {
    ...
    md_vals <- paste(md[names(mc@mc), "line"], md_vals, sep = "_")
    names(md_vals) <- names(mc@mc)
    mcell_mc2d_plot_by_factor("eseb_07_TKO_bs500f_got_s2m", "eseb_07_TKO",
        meta_field = "rep_and_day",
        meta_data_vals = md_vals, ncols = 8, single_plot = F, neto_points = T
    )
}
